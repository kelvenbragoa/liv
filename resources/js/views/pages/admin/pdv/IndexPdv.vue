...
function getTableIconClasses(statusId) {
    switch (statusId) {
        case 1:
            return ['bg-green-200', 'dark:bg-green-400/10'];
        case 2:
            return ['bg-red-200', 'dark:bg-red-400/10'];
        case 3:
            return ['bg-yellow-200', 'dark:bg-yellow-400/10'];
        case 4:
            return ['bg-purple-200', 'dark:bg-purple-400/10'];
        case 5:
            return ['bg-blue-200', 'dark:bg-blue-400/10'];
        case 6:
            return ['bg-gray-200', 'dark:bg-gray-400/10'];
        default:
            return ['bg-surface-200', 'dark:bg-surface-400/10'];
    }
}
