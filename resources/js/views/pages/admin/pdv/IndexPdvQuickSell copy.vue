            ...
            <div class="grid grid-cols-12 gap-4 h-screen">
                <div class="col-span-12 lg:col-span-3 h-full">
                    ...
                    <div v-if="total > 0" class="mt-4">
                        <Select v-model="payment_method_id" :options="payment_methods" optionLabel="name" optionValue="id" placeholder="Selecionar" class="w-full" />
                        ...
                        <strong class="block mt-2">Total: {{ total }} MT</strong>
